        ...
        >
          <div style={{display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column'}}>
            ...
            <div style={{display:'flex', justifyContent:'center', alignItems:'center'}}>
                ...
                <button style={{width:'40px', backgroundColor:'green', marginLeft:'25px', borderColor:'transparent'}} onClick={()=>{cancelSession()}}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                    </svg>
                </button>

                <button style={{width:'40px',backgroundColor:'darkred', borderColor:'transparent'}} onClick={()=>{setModalOpen(false); areYouSureInfo.setCancelTheSession(false)}}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
