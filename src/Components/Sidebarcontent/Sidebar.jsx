      ...
      <div className='sidebarcontent'>
        ...
        <div className='the-title'>
          ...
          <h1 className='h1-text' style={{marginTop:'0', }} >
            ...
            <hr className='breakpoint' style={{width:'10px', marginBottom:'45px' }}/>
        ...
        <h3 className='text' onClick={()=>{barInfo.setData(true)}}>
         ...
         <label className='theLabel'>My Data</label> 
        </h3>
        ...
        <h3 className='text' onClick={()=>{barInfo.setOpenThemePage(true)}}>
          ...
          <label className='theLabel'>Theme</label>
        </h3>
        ...
        <h3 className='text'  onClick={()=>{barInfo.setSynopsis(true)}}>
          ...
          <label className='theLabel'>Rating System</label>
        </h3>
        ...
        <BsDoorOpen style={{fontSize:'35px', marginLeft: '23px', marginRight:'9px'}}/>
           <label className='theLabel'>Logout</label> 
        </h3>
        :
