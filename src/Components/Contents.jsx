...
const Contents = () => {
  ...
  const questionMark =()=>{
    return <button className='questionMark' title="The rating system" onClick={()=>{setterInfo.setSynopsis(true)}} style={{backgroundColor:'transparent', width:'38px', marginRight:'0',borderRadius:'20%'}}>
