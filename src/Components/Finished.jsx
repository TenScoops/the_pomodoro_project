  ...
  return (
    <div className='divfinished'>
      <div className='finished' >
          ...
          <p style={{fontSize:'30px', marginTop:'0', marginBottom:'10px'}}>Session Complete!</p>
          ...
          <p style={{width:'350px', marginBottom:'20px', fontSize:'13.5px', marginLeft:'8px'}}>Take a look at the "My Data" section to view your progress.</p>
          </div>
          <button className='newsession' onClick={()=>{startNewSession()}}>Start A New Session</button>
