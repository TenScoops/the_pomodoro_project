  ...
  return (
    <div className='divfinished'>
      <div className='finished' >
          ...
          <p style={{fontSize:'25px', marginTop:'0'}}>Session Complete!</p>
          <p style={{fontSize:'20px', marginBottom:'80px',marginTop:'0'}}>Session Score: </p>
          <button className='newsession' onClick={()=>{cancelSession()}}>Start a new session</button>
